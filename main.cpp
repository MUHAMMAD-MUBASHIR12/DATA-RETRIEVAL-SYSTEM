...
public:
    bool login_status()
    {
        ...
        while (loginAttempt < MAX_LOGIN_ATTEMPTS)
        {
            ...
            if (userName == "Ali" && userPassword == "12345")
            {
                cout << "Welcome Ali!\n";
                cout << "You are now logged in!\n\n";
                return true;
            }
            else if (userName == "Raza" && userPassword == "12345")
            {
                cout << "Welcome Raza!\n";
                cout << "You are now logged in!\n\n";
                return true;
            }
            else if (userName == "Umer" && userPassword == "12345")
            {
                cout << "Welcome Umer!\n";
                cout << "You are now logged in!\n\n";
                return true;
            }
            else if (userName == "Usman" && userPassword == "12345")
            {
                cout << "Welcome !\n";
                cout << "You are now logged in!\n\n";
                return true;
